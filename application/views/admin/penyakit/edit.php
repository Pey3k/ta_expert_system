			...
			<div class="row">
				<div class="col-10">
					<div class="card shadow">
						...
						<div class="card-body">						
            <form method="post" action="<?php echo base_url().'admin/penyakit/doUpdate/'.$this->uri->segment(4)?>"
                role="form">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <input type="text" class="form-control" style="width:250px" name="id_penyakit" id="id_penyakit"
                            placeholder="" value="<?php echo $detailData->id_penyakit ?>" readonly>
                    </div>
                    <div class="form-group col-md-7">
                        <label for="penyakit">Nama Penyakit</label>
                        <input type="text" class="form-control" style="width:370px" name="penyakit" id="penyakit"
                            placeholder="" value="<?php echo $detailData->penyakit?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="keterangan">Keterangan</label>
                    <input type="text" class="form-control" style="width:730px " name="keterangan" id="keterangan"
