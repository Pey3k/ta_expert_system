	...
	<div class="content-wrapper">
       ...
       echo $this->session->flashdata('msgbox');?>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" style="width:330px " name="id_penyakit" id="id_penyakit"
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" style="width:530px" name="penyakit" id="penyakit"
										placeholder="">
								</div>

								<div class="form-group">
									<label for="keterangan">Keterangan Penyakit</label>
									<textarea style="width:730px" class="form-control" id="" name="keterangan" rows="3"></textarea>
