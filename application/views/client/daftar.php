              ...
              <h2 class="h4 text-black mb-5">Masukan data diri anda :</h2>
     			  ...
     			  <div class="row form-group">
                     <div class="col-md-12">
                       ...
                       <input type="text" id="nama" name="nama" class="form-control rounded-0" value="<?= set_value('nama'); ?>"required>
                     </div>
                   </div>
     			  ...
     			  <div class="row form-group">
                     <div class="col-md-6">
                       ...
                       <input type="number" id="umur" name="umur" min="1" max="100" value="<?= set_value('umur'); ?>" class="form-control rounded-0">
                     </div>

     				<div class="col-md-6">
     					<label   class="text-black" for="jk">Jenis Kelamin</label>
                             <select name="jk" id="jk" class="form-control rounded-0" required autofocus value="<?= set_value('jk');?>">
     			  ...
     			  <div class="row form-group">
                     <div class="col-md-12">
                       ...
                       <input type="email" id="email" name="email" class="form-control rounded-0" value="<?= set_value('email'); ?>">
                     </div>
                   </div>
                    ...
                    <div class="row form-group">
                     <div class="col-md-12">
                       ...
                       <input type="text" id="username" name="username" class="form-control rounded-0" value="<?= set_value('username'); ?>" required>
                   ...
                   <div class="row form-group">
                     <div class="col-md-6">
                       ...
                       <input type="password" id="password1" name="password1" class="form-control rounded-0" required>
                   ...
                   <div class="row form-group">
                     <div class="col-md-12 mt-4 ml-3">
                       <input type="submit" value="Register Sekarang!" class="btn btn-black rounded-0 py-3 px-4">
