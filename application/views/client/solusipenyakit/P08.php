         ...
         <div class="col-md-12 mb-5 mb-md-0">
                    ...
                    echo $this->session->flashdata('msgbox');?>
                     ...
                     <div class="col-sm-12">
         			           ...
         			           <p>
                         <a href="<?= base_url('penyakit/jantung') ?>" class="btn btn-black btn-outline-black rounded-0 d-block mb-2 mb-lg-0 d-lg-inline-block">Baca Selengkapnya Penyakit <?= $dataPenyakit->penyakit ?> !</a>
                       </p>
