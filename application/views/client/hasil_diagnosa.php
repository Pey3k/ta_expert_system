...
<!--
              ...
              <p>Hasil setelah dilakukan penghitungan matematis menggunakan metode <i>Dempster Shafer</i>, pasien terdiagnosa terkena gangguan: </p>
                      <ul>
                      </ul>
                      <?php
                    ...
                    ?> <br>
                        <a href="<?= base_url() ?>/diagnosa/solusi/<?= $value ?>">lihat Solusi disini</a><br></li>
                      <?php  }
                      }
                      ?>
                    </div>
                    <h3 class="mt-2" style="text-align:center;">Seluruh hasil dari diagnosa bersifat <b>PREDIKSI</b> menggunakan perhitungan metode <b><i>Dempster Shafer</b></i> berdasarkan pengelolaan data dari pakar!</h3>
              ...
              <table class="table table-striped table-bordered mt-1" style="width: 80%; height: 50px; ">
                ...
                <tr>
                  ...
                  <td style="padding:10px;"> <?php if($row->kode == "teta"){echo "&theta;";}else{echo $row->kode;}?> </td>
            ...
            <div class="row">
              ...
              <div class="col-md-6 ">
            <a href="<?php echo base_url('diagnosa'); ?>" class="btn btn-xl btn-primary mt-2"><i class="ace-icon fa fa-angle-double-left "></i> Kembali Diagnosa</a>
            </div>
            <div class="col-md-6">
              <form method="post" action="<?php echo base_url('diagnosa/tampil_hitung'); ?>">
                <input type="hidden" name="data" value='<?= json_encode($data["hasil"]) ?>'>
                <button class="btn btn-xl btn-warning mt-2" style="margin-left:300px;"><i class="ace-icon fa fa-angle-double-left "></i> Tampil Perhitungan !</button>
              </form>
          </div>
            </div>
            </div>
