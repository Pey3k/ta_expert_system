...
<html lang="en">
<head>
	<title>WAOS - Riwayat Konsultasi</title>
	<meta charset="utf-8">
	...
	<div class="container">
		<div class="row no-gutters slider-text align-items-center justify-content-center">
			<div class="col-md-9 ftco-animate text-center">
				<h1 class="mb-2 bread">Riwayat Konsultasi</h1>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		<div class="row">
			<div class="card shadow col-md-12 ftco-animate">
						...
						<div class="col-md-6 ftco-animate">
							<?php if (!empty($userLogin)) { ?>
								<div class="col-12 text-right">
									<a href="<?php echo base_url('riwayatpasien/print_pasien/') ?>"
									   target="_blank()">
				...
				<div class="card-body col-md-12 ftco-animate">
