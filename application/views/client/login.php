	...
	<div class="container d-flex align-items-center">
		...
		<div class="collapse navbar-collapse" id="ftco-nav">
			<ul class="navbar-nav m-auto">
				...
				<li class="nav-item active"><a href="<?= base_url('login') ?>" class="nav-link">Masuk</a></li>
				<li class="nav-item"><a href="<?= base_url('daftar') ?>" class="nav-link">Daftar</a>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="container">
		<div class="row no-gutters slider-text align-items-center justify-content-center">
			<div class="col-md-9 ftco-animate text-center">
				<h1 class="mb-2 bread">Login Pasien</h1>
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<form action="<?= base_url('login/doLogin'); ?>" method="post" class="p-5 bg-white">
					...
					<div class="row form-group">
						<div class="col-md-12">
							<input type="submit" value="Log In" class="btn btn-info rounded-0 py-3 px-4">
						</div>
					</div>
				</form>
			</div>
