        ...
        <div class="bg-white py-4 mb-2">
          <div class="row mx-4 my-4 product-item-2 align-items-start">
            <div class="col-md-12 mb-2 mb-md-0">
              ...
              ?> <br>
                  <a href="<?= base_url('riwayatpasien');?>">Lihat riwayat konsultasi</a><br></li>
                <?php  }
                }
                ?>
              </div>
              ...
              <br>
              <a href="<?php echo base_url('diagnosa'); ?>" class="btn btn-xl btn-primary"><i class="ace-icon fa fa-angle-double-left"></i> Kembali Diagnosa</a>
              </form>
            </div>
          </div>
        </div>
