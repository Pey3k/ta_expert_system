...
<html lang="en">
<head>
	<title>WAOS - Penyakit Karies Gigi</title>
	<meta charset="utf-8">
	...
	<div class="container">
		<div class="row no-gutters slider-text align-items-center justify-content-center">
			<div class="col-md-9 ftco-animate text-center">
				<h1 class="mb-2 bread">Penyakit Karies Gigi</h1>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 ftco-animate">
				<h2 class="mb-3">Penyakit Karies Gigi</h2>
				<p>
					<img src="<?= base_url() . "assets/frontend/images/penyakit/karies.jpg" ?>" alt="" width="80%"
						 class="img-fluid">
				</p>
				<p>Beberapa orang atau bahkan Anda sendiri mungkin masih bingung mengenai perbedaan karies gigi dan gigi
					berlubang. Pasalnya, kedua kondisi ini memiliki ciri-ciri yang sama, yaitu adanya lubang pada gigi.
				</p>
				<p>Faktanya, karies gigi dan gigi berlubang adalah dua kondisi yang saling berhubungan. Karies gigi
					sebetulnya merupakan istilah medis yang lebih dikenal sebagai kerusakan gigi atau gigi
					berlubang.</p>
				<p>Karies gigi adalah kondisi rusaknya struktur dan lapisan gigi yang terjadi secara bertahap. Hal ini
					diawali dengan terkikisnya enamel atau lapisan terluar gigi, kemudian menggerogoti dentin atau
					lapisan tengah gigi, dan pada akhirnya mencapai sementum alias akar gigi.</p>
				<p>Karies gigi umumnya disebabkan oleh kebiasaan makan makanan manis atau jarang menyikat gigi. Saat
					Anda mengonsumsi makanan manis, bakteri di mulut akan mengubah kandungan gula dari sisa-sisa makanan
					menjadi asam.</p>
				<p>Bila Anda malas menyikat gigi, timbunan asam tersebut dapat berubah menjadi plak berwarna putih,
					kuning, cokelat, atau kehitaman pada gigi. Jika karies gigi ini tidak segera diatasi, maka kerusakan
					gigi bisa jadi lebih parah dan menyebabkan gigi berlubang.</p>
				<p>Pada awalnya, muncul bercak putih atau white spot pada gigi Anda. Kemudian bila dibiarkan terus
					menerus, bercak putih akan berubah menjadi kecoklatan dan mulai membentuk lubang pada gigi.</p>
				<p>Karena inilah Anda akan merasakan ngilu sesaat setelah mengonsumsi makanan atau minuman yang dingin,
					panas, atau manis. Lama-kelamaan, gigi berlubang yang sudah parah bisa membuat Anda mengalami sakit
					gigi yang tak tertahankan.</p>
