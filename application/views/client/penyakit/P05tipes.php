...
<div class="site-section bg-light" id="pola-hidup-section">
  ...
  <p>Tipes merupakan penyakit yang dikarenakan kurangnya perhatian terhadap kebesihan seseorang. Kebersihan tersebut meliputi kebersihan diri, makanan bahkan lingkungan. Perlunya menjaga kebersihan menjadi faktor utama penyakit tipes karena bakteri tersebut dapat menyebar secara cepat pada penderita yang tidak menjaga kebersihan..</p>
  </div>
    </div>
          ...
          <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner" data-aos="fade">
              <div class="carousel-item active">
                <img class="img-fluid img-thumbnail" src="<?= base_url('assets/images/penyakit/tipes/gambar1.jpg');?>" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="img-fluid img-thumbnail" src="<?= base_url('assets/images/penyakit/tipes/gambar3.jpg');?>" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="img-fluid img-thumbnail" src="<?= base_url('assets/images/penyakit/tipes/gambar2.jpg');?>" alt="Third slide">
              </div>
              <div class="carousel-item">
                <img class="img-fluid img-thumbnail" src="<?= base_url('assets/images/penyakit/tipes/gambar4.jpg');?>" alt="Fourth slide">
              </div>
            </div>
...
<div class="col-md-5 mr-auto product-title-wrap order-2 order-md-1" data-aos="fade">
    ...
    <p class="mb-4" style="text-align:justify; font-size:16px;" >
      Tipes dikenal dengan demam tifoid yaitu sebuah penyakit dikarenakan sebuah bakteri yang penyebarannya di sebarkan melalui makanan, air atau dari orang yang terinfeksi. Penyakit tipes memang tidak terlihat berbahaya
       namun dikarenakan pola hidup yang tidak dijaga dapat menyebabkan penyakit tersebut terutama masalah kebersihan.</p>
    <p class="mb-4" style="text-align:justify; font-size:16px;">
      Gejala penderita tipes biasanya demam hingga suhu yang sangat tinggi, namun hal tersebut memerlukan perlakuan medis yang benar supaya tidak semakin parah. Menjaga kebersihan menjadi salah satu faktor utama
      dari penyakit tipes. </p>
    <hr>
<p>
      <a href="#faktor-tipes-section" class="btn btn-black btn-outline-black rounded-0 d-block mb-2 mb-lg-0 d-lg-inline-block main-menu js-clone-nav ">Baca Faktor Penyakit Tipes !</a>
    </p>
  </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 " data-aos="fade" data-aos-delay="100">
        <div class="person text-center">
            <img src="<?= base_url('assets/images/penyakit/tipes/faktor1.jpg');?>"  alt="Image" class="img-fluid img-thumbnail rounded w-75 mb-3">
          <h2 class="text-black font-weight-bold">Bakteri</h2>
          <p class="mb-4 pl-2 pr-2" align="justify" style="font-size:14px">
            Bakteri penyebab tipes adalah bakteri <i>Salomonella thypi</i> yaitu bakteri yang terkontaminasi dengan feses. Bakteri tersebut sering ditemukan di berbagai tempat kotor seperti dalam air, makanan dan minuman.</p>
        <hr>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
        <div class="person text-center">
            <img src="<?= base_url('assets/images/penyakit/tipes/faktor2.jpg');?>"  alt="Image" class="img-fluid img-thumbnail rounded w-75 mb-3">
          <h2 class="text-black font-weight-bold">Makan Sembarang</h2>
          <p class="mb-4 pl-2 pr-2" align="justify" style="font-size:14px">
            Makanan menjadi sumber utama kebutuhan kita sebagai manusia. Kebersihan makanan perlu diperhatikan untuk menjauhi dari berbagai macam bakteri penyakit, salah satunya bakteri penyebab tipes yang terdapat pada makanan kotor.</p>
          <hr>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
        <div class="person text-center">
             <img class="img-fluid img-thumbnail rounded w-75 mb-3" src="<?= base_url('assets/images/penyakit/tipes/faktor3.jpg');?>" alt="Image">
          <h2 class="text-black font-weight-bold" style='font-size:25px'>Tidak Menjaga Kebersihan</h2>
          <p class="mb-4 pl-2 pr-2" align="justify" style="font-size:14px; padding-top:10px;">
            Kebersihan merupakan sebuah usaha untuk menjaga diri dari suatu kondisi yang tidak mengenakan. Kebersihan lingkungan sekitar perlu diperhatikan oleh seseorang terutama kebersihan diri sendiri. </p>
           <hr>
