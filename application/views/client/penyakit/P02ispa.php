  ...
  <div class="container">
    <div class="row mb-1 justify-content-center" data-aos="fade" data-aos-delay="150">
      <div class="col-md-12 text-center">
        <h3 class="section-sub-title mt-4">Upper Respiratory Infection</h3>
        <h2 class="section-title mt-1" >Infeksi Saluran Pernapasan Akut</h2>
  <p>Infeksi Saluran Pernapasan Akut merupakan penyakit yang dialami oleh banyak orang. Infeksi ini merupakan
     jenis penyakit yang menyebabkan gangguan pada pernapasan seseorang. ISPA dapat terjadi kapan saja terutama padat musim hujan.
          ...
          <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner" data-aos="fade">
              <div class="carousel-item active">
                <img class="img-fluid img-thumbnail" src="<?= base_url('assets/images/penyakit/ispa/gambar4.jpg');?>" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="img-fluid img-thumbnail" src="<?= base_url('assets/images/penyakit/ispa/gambar1.jpg');?>" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="img-fluid img-thumbnail" src="<?= base_url('assets/images/penyakit/ispa/gambar2.jpg');?>" alt="Third slide">
              </div>
              <div class="carousel-item">
                <img class="img-fluid img-thumbnail" src="<?= base_url('assets/images/penyakit/ispa/gambar3.jpg');?>" alt="Fourth slide">
              </div>
            </div>
...
<div class="col-md-5 mr-auto product-title-wrap order-2 order-md-1" data-aos="fade">
    ...
    <p class="mb-4" style="text-align:justify; font-size:16px;" >
      Infeksi Saluran Pernapasan Akut (ISPA) disebabkan oleh serangan langsung terhadap penapasan seseorang terutama melalui mulu dan hidung. Penyebab utama dari ISPA adalah virus atau bakteri.
      Virus dan bakteri yang sering menyerang penderita antara lain virus influenza, adenovirus dan antivirals. ISPA yang tidak segera ditangani akan menyebabkan penyakit berbahaya.
    <p class="mb-4" style="text-align:justify; font-size:16px;">
      Infeksi tersebut dapat menyebabkan bronkitis hingga akut. Bronkitis merupakan infeksi pada saluran pernapasan akut yang menyebabkan iritasi pada saluran udara yang menuju paru - paru. Bronkitis awalnya
       seperti penyakit ISPA biasanya di awali dengan gejala - gejala seperti batuk, sesak napas hingga menyebabkan daya tahan hubung yang melemah.</p>
    <hr>
<p>
      <a href="#faktor-ispa-section" class="btn btn-black btn-outline-black rounded-0 d-block mb-2 mb-lg-0 d-lg-inline-block main-menu js-clone-nav ">Baca Faktor Infeksi Saluran Pernapasan Akut !</a>
    </p>
  </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 " data-aos="fade" data-aos-delay="100">
        <div class="person text-center">
            <img src="<?= base_url('assets/images/penyakit/ispa/faktor1.jpg');?>"  alt="Image" class="img-fluid img-thumbnail rounded w-75 mb-3">
          <h2 class="text-black font-weight-bold">Virus dan Bakteri</h2>
          <p class="mb-4 pl-2 pr-2" align="justify" style="font-size:14px">
            Virus dan bakteri merupakan faktor utama dari Infeksi Saluran Pernapasa Akut (ISPA). Penyebaran virus dan bakteri tersebut di sebarkan oleh penderita
            melalui udara. Terdapat berbagai virus dan bakteri yang berbahaya
            seperti influenza. Selain melalui udara, virus dan bakter tersebut dapat disebarkan melalui
          cairan seperti air liur, maka sangat perlu untuk menjaga kebersihan lingkungan dan tubuh. </p>
        <hr>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
        <div class="person text-center">
            <img src="<?= base_url('assets/images/penyakit/ispa/faktor2.jpg');?>"  alt="Image" class="img-fluid img-thumbnail rounded w-75 mb-3">
          <h2 class="text-black font-weight-bold">Bersin</h2>
          <p class="mb-4 pl-2 pr-2" align="justify" style="font-size:14px">
            Bersin menjadi faktor penyabab tersebarnya virus pembawa Infeksi Saluran Pernapasan Akut (ISPA). Virus dan bakteri yang tersebar melalui bersin dapat mudah menyebar karena udara disekitar, apalagi udara yang lembab memudahkan masuk ke tubuh. Penyebaran virus dan bakteri tersebut dari orang ke orang dan dapat menyebar lebih dari satu orang, sehingga penyebaran relatif cepat dan bahaya.</p>
          <hr>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
        <div class="person text-center">
             <img class="img-fluid img-thumbnail rounded w-75 mb-3" src="<?= base_url('assets/images/penyakit/ispa/faktor3.jpg');?>" alt="Image">
          <h2 class="text-black font-weight-bold">Batuk</h2>
          <p class="mb-4 pl-2 pr-2" align="justify" style="font-size:14px">
            Penyebaran Infeksi Saluran Pernapasan Akut (ISPA) juga dapat melalui batuk dari penderita yang menular ke individu lainnya. Sama halnya dengan bersin batuk menyebabkan virus dan bakteri infeksi tersebut tersebar melalui udara disekitar. Batuk dari penderita lebih bahaya dibandingkan bersin, karena batuk tersebut bersifat keras dan penyebaran dapat disebarkan kepada orang disekitar penderita.</p>
           <hr>
...
<!-- Modal -->
<div class="modal fade" id="info_obesitas" tabindex="-1" role="dialog" aria-labelledby="info_obesitas" aria-hidden="true">
