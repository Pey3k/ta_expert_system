			...
			<div class="row mb-1 justify-content-center" data-aos="fade" data-aos-delay="150">
				<div class="col-md-12 text-center">
					...
					<p>
						...
						terinfeksi hepatitis. Penyakit hepatitis memiliki 5 jenis virus yaitu hepatitis A, B, C dan E
						yang memiliki karakter berbeda setiap jenis penyakit tersebut.</p>
				</div>
			</div>
				...
				<div class="row mx-4 my-4 product-item-2 align-items-start">
							...
							<div class="carousel-inner" data-aos="fade">
								<div class="carousel-item active">
									<img class="img-fluid img-thumbnail"
										 src="<?= base_url('assets/images/penyakit/hepatitis/gambar2.jpg'); ?>"
										 alt="First slide">
								</div>
								<div class="carousel-item">
									<img class="img-fluid img-thumbnail"
										 src="<?= base_url('assets/images/penyakit/hepatitis/gambar1.jpg'); ?>"
										 alt="Second slide">
								</div>
								<div class="carousel-item">
									<img class="img-fluid img-thumbnail"
										 src="<?= base_url('assets/images/penyakit/hepatitis/gambar3.jpg'); ?>"
										 alt="Third slide">
								</div>
								<div class="carousel-item">
									<img class="img-fluid img-thumbnail"
										 src="<?= base_url('assets/images/penyakit/hepatitis/gambar4.jpg'); ?>"
										 alt="Fourth slide">
								</div>
							</div>
					...
					<div class="col-md-5 ml-auto product-title-wrap" data-aos="fade">
						...
						<p class="mb-4" style="text-align:justify; font-size:16px;">
							Infeksi hepatitis yang paling sering menyerang remaja adalah hepatitis A dan B. Hepatitis A
							biasanya disebabkan oleh lingkungan yang tidak bersih berakibat virus hepatitis A mudah
							tersebar
							pada lingkungan kotor tersebut, sedangkan hepatitis B ditularkan melalui virus dengan
							melakukan kontak seksual. Kedua jenis hepatitis tersebut sama - sama memiliki akibat yang
							tinggi.</p>
						<p class="mb-4" style="text-align:justify; font-size:16px;">
							Penyakit hepatitis menyerang hati penderita dan merusak dari dalam. Kebanyakan orang yang
							terinfeksi virus hepatitis tidak tahu mengapa mereka bisa terkena virus tersebut tanpa
							disadari.
							Banyak kasus penyakith hepatitis yang mengalami kondisi kronis. Awalnya hanya mengidap
							hepatitis namun jika hingga terkena hepatitis kronis berisiko tinggi terkena kanker
							hati. </p>
						<hr>
						<p>
							<a href="#faktor-hepatitis-section"
							   class="btn btn-black btn-outline-black rounded-0 d-block mb-2 mb-lg-0 d-lg-inline-block main-menu js-clone-nav ">Baca
								Faktor Penyakit Hepatitis !</a>
						</p>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-md-6 col-lg-4 mb-5 mb-lg-0 " data-aos="fade" data-aos-delay="100">
							<div class="person text-center">
								<img src="<?= base_url('assets/images/penyakit/hepatitis/faktor1.jpg'); ?>" alt="Image"
								...
								<p class="mb-4 pl-2 pr-2" align="justify" style="font-size:14px">
									Virus hepatitis mudah tersebar melalui berbagai macam cara. Kebiasaan tidak menjaga
									lingkungan bersih menyebabkan virus tersebut mudah bersarang pada lingkungan yang
									kotor. Kasus tertentu pada penderita hepatitis virus disebarkan melalui alat yang
									terkontaminasi seperti tindik suntik dan jarum transfusi. </p>
								<hr>
							</div>
						</div>
						...
						<div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
							<div class="person text-center">
								<img src="<?= base_url('assets/images/penyakit/hepatitis/faktor2.jpg'); ?>" alt="Image"
									 class="img-fluid img-thumbnail rounded w-75 mb-3">
								<h2 class="text-black font-weight-bold">Seks</h2>
								<p class="mb-4 pl-2 pr-2" align="justify" style="font-size:14px">
									Hubungan seks yang tidak sehat menyebabkan penularan virus hepatitis sangat mudah
									menyerang penderita. Seks bebas apalagi tanpa pengaman menyebabkan penderita
									hepatitis secara mudah menyalurkan virus tersebut kepada orang lain tanpa disadari.
									Banyak kasus hubungan seksual yang menyebabkan hal tersebut.</p>
								<hr>
							</div>
						</div>
						...
						<div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
							<div class="person text-center">
								<img class="img-fluid img-thumbnail rounded w-75 mb-3"
									 src="<?= base_url('assets/images/penyakit/hepatitis/faktor3.jpg'); ?>" alt="Image">
								<h2 class="text-black font-weight-bold">Alkohol</h2>
								<p class="mb-4 pl-2 pr-2" align="justify" style="font-size:14px">
									Kita ketahui bahwa alkohol memiliki dampak yang buruk bagi tubuh terutama organ
									hati. Konsumsi alkohol yang berlebihan dapat melemahkan kerja hati sehingga rendan
									terhadap infeksi hepatitis. Selain itu alkohol juga menyebabkan penyakit hati
									seperti perlemakan hati alkoholik yaitu penumpukan lemak di hati hinnga kerusakan
									hati. </p>
								<hr>
