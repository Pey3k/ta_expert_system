					...
					<nav class="site-navigation position-relative text-right" role="navigation">
						...
						<ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
							...
							<li><a href="<?= base_url('auth/#tentang-kami-section') ?>" class="nav-link">Tentang
									Kami</a></li>
							<li><a href="<?= base_url('auth/#pola-hidup-section') ?>" class="nav-link active">Pola Hidup
									Sehat</a></li>
		...
		<div class="container mt-5">
			<div class="row mb-1">
				<div class="col-12 text-center">
					...
					<h3 class="section-sub-title mt-3">Healthy Food</h3>
					<h2 class="section-title pb-0">Pola Makan Hidup Sehat</h2>
				</div>
			</div>
			<hr>
					...
					<div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img class="d-block w-100" src="<?= base_url('assets/images/polamakan/gambar1.png'); ?>"
									 alt="First slide">
							</div>
							<div class="carousel-item">
								<img class="d-block w-100" src="<?= base_url('assets/images/polamakan/gambar2.png'); ?>"
									 alt="Second slide">
							</div>
							<div class="carousel-item">
								<img class="d-block w-100" src="<?= base_url('assets/images/polamakan/gambar3.png'); ?>"
									 alt="Third slide">
							</div>
						</div>
