                    ...
                    <div class="row">
                      <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 " data-aos="fade" data-aos-delay="100">
                        <div class="person text-center">
                            <img src="<?= base_url('assets/images/polahidup/gizi/gambar2.jpg');?>"  alt="Image" class="img-fluid img-thumbnail rounded w-75 mb-3">
                          <h2 class="text-black font-weight-bold">4 Sehat 5 Sempurna</h2>
                          <p class="mb-4 pl-2 pr-2" align="justify" style="font-size:14px">
                            4 sehat 5 sempurna merupakan sebuah pola makan yang mencangkup seluruh zat gizi yang diperlukan oleh tubuh dalam jenis makanan yang berbeda. Pola makan tersebut memiliki manfaat yang sangat berguna bagi tubuh dan kesehatan.  Makanan tersebut terdiri dari makanan pokok, lauk pauk, sayur dan buah dan susu. Makanan pokok menjadi sumber energi bagi tubuh dengan batasan porsi yang sesuai dengan kebutuhan. Lauk pauk merupakan zat pembangun untuk tubuh yang dapat didapatkan dalam bentuk nabati maupun hewani, dagin ayam , sapi dan ikan merupakan sumber hewani, sedangkan tahu, tempe dan kacang merupakan sumber nabati. Sayur dan buah menjadi sumber vitamin bagi tubuh dan susu untuk pertumbuhan bagi tubuh terutama tulang.</p>
                      ...
                      <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
                        <div class="person text-center">
                            <img src="<?= base_url('assets/images/polahidup/gizi/gambar3.jpg');?>"  alt="Image" class="img-fluid img-thumbnail rounded w-75 mb-3">
                          <h2 class="text-black font-weight-bold">Asupan Kalori</h2>
                          <p class="mb-4 pl-2 pr-2" align="justify" style="font-size:14px">
                            Kebutuhan kalori setiap individu memiliki perbedaan masing – masing tergantung individu tersebut. Beberapa faktor yang mempengaruhi asupan kalori dalam tubuh seperti gaya hidup, genetik, pola diet, usia dan jenis kelamin. Asupan kalori secara umum rata – rata 2.500 kalori setiap hari untuk laki – laki dan 2.000 kalori untuk perempuan. Jumlah tersebut juga masih tergantung dengan aktivitas yang dilakukan orang tersebut. Pembakaran kalori juga perlu dilakukan untuk menurunkan berat badan sehingga kalori tidak berubah menjadi tumpukan lemak. Hal tersebut berpengaruh juga dengan pola diet yang dilakukan oleh setiap individu. Beberapa hal yang dapat dilakukan untuk menjaga asupan kalori seperti mengurangi asupan karbohidrat, menghindari makanan atau minuman mengandung gula, minum air putih minimal 2 liter setiap hari dan mlakukan olahraga rutin untuk mempertahankan massa otot.</p>
                          <hr>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
                        <div class="person text-center">
                             <img class="img-fluid img-thumbnail rounded w-75 mb-3" src="<?= base_url('assets/images/polahidup/gizi/gambar1.jpg');?>" alt="Image">
                          <h2 class="text-black font-weight-bold">Waktu Makan</h2>
                          <p class="mb-4 pl-2 pr-2" align="justify" style="font-size:14px">Jam makan juga wajib diperhatikan untuk menunjang pola gizi yang seimbang. Waktu makan yang ideal terdiri dari sarapan, makan siang dan makan malam meskipun hal tersebut sering tidak diperhatikan oleh remaja. Sarapan atau makan pagi merupakan hal yang penting untuk memberikan energi selama beraktivitas. Sarapa paling ideal dilakukan 30 menit setelah bangun tidur pada rentang jam 07.00 – 10.00 pagi. Waktu yang tepat untuk makan siang yaitu pukul 12.30 – 14.00 siang dan tidak dianjurkan makan setelah pukul 16.00, karena jarak ideal untuk memproses makanan dalam pencernaan yaitu 4 jam. Pastikan makan siang terdiri dari makanan yang mengandung nutrisi lengkap seperti 4 sehat 5 sempurna. Makan malam bukan berarti dapat menambah berat badan semakin cepat, perut yang lapar dimalam hari justru membuat tubuh tidak bisa untuk berisitrahat. Waktu yang tepat untuk makan pada malam hari ialah pada pukul 18.00 – 21.00 dengan pilihan makanan yang penuh nutrisi vitamin seperti buah dan sayur, salad, capcay. Pastikan sebelum tidur, makanan telah di cerna oleh tubuh yaitu 3 jam sebelum tidur agar dicerna dengan tuntas dan tidak menyebabkan kenaikan asam lambung. </p>
                           <hr>
