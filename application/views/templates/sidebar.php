<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
	<div class="navbar-header">
		<ul class="nav navbar-nav flex-row">
			<li class="nav-item mr-auto"><a class="navbar-brand" href="#">
					<h2 class="brand-text mb-0 ">Expert System</h2>
				</a></li>
	...
	<div class="main-menu-content">
		<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="">
			...
			<li class=" nav-item <?= ($cur1=="dashboard") ? "active" : ""; ?>"><a href=""><i
						class="bx bx-home-alt"></i><span class="menu-title">Dashboard</span></a>
			</li>
			<li class=" navigation-header"><span>Management Data Master</span>
			</li>
			<li class=" nav-item <?= ($cur1=="pakar") ? "active" : ""; ?>"><a href="<?= base_url('admin/pakar');?>"><i
						class="bx bx-folder"></i><span class="menu-title">Data Pakar</span></a>
			</li>
			<li class=" nav-item <?= ($cur1=="pasien") ? "active" : ""; ?>"><a href="<?= base_url('admin/pasien');?>"><i
						class="bx bx-folder"></i><span class="menu-title">Data Pasien</span></a>
			</li>
			<li class=" nav-item <?= ($cur1=="gejala") ? "active" : ""; ?>"><a href="<?= base_url('admin/gejala');?>"><i
			...
			<li class=" nav-item <?= ($cur1=="solusi") ? "active" : ""; ?>"><a href="<?= base_url('admin/solusi');?>"><i
						class="bx bx-folder"></i><span class="menu-title">Data Solusi</span></a>
			</li>

			<li class=" navigation-header"><span>Management Report</span>
			</li>
			<li class=" nav-item"><a href=""><i class="bx bx-file"></i><span class="menu-title">Laporan
						Pasien</span></a>
			</li>
			<li class=" nav-item"><a href=""><i class="bx bx-file"></i><span class="menu-title">Laporan
						Diagnosa</span></a>
